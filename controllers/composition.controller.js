...
exports.edit_composition = function (req, res, next) {
  console.log(req)
  Composition.updateOne(
    { _id: req.params.categoryId, 'compositions._id': req.params.compositionId },
    {
      $set: {
        'compositions.$': {
          _id: req.params.compositionId,
          name: req.body.name,
          tone: req.body.tone,
